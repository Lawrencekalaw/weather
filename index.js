    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${APIkey}`).then(response => response.json()).then(json => {
        ...
        if(cityHide.textContent == city){
            ...
            switch (json.weather[0].main) {
                case 'Clear':
                    image.src = 'weather3.jpg';
                    break;
                case 'Rain':
                    image.src = 'weather6.jpg';
                    break;
                case 'Snow':
                    image.src = 'weather7.jpg';
                    break;
                case 'Clouds':
                    image.src = 'weather4.jpg';
                    break;
                case 'Mist':
                    image.src = 'weather5.jpg';
                    break;
                case 'Haze':
                    image.src = 'weather5.jpg';
                    break;
            ...
            if(totalCloneInfoWeather > 0){
                ...
                cloneInfoHumidityFirst.classList.remove('active')
                ;
                cloneInfoWindFirst.classList.remove('active');
